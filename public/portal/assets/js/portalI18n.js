...
const portalTranslations = {
  ...
  en: {
    ...
    navMySickNotes: 'Paragraphs & OCR',
    navMyRequests: 'My Requests',
    navAdmin: 'Administration',
    navAdminDashboard: 'Admin Dashboard',
    navEmployees: 'Employees',
    navQuotas: 'Quotas',
    navAllSickNotes: 'All Paragraphs & OCR',
    ...
    // My Sick Notes (Paragraphs & OCR)
    mySickNotesTitle: 'Paragraphs & OCR',
    mySickNotesDesc: 'Paragraph and OCR document records',
    ...
    quotaSettingsDefaultOcr: 'Default OCR',
    ...
    colOcrTotal: 'OCR total',
    colOcrUsed: 'OCR used',

    // Admin Sick Notes
    allSickNotesTitle: 'All Paragraphs & OCR',
    allSickNotesDesc: 'Paragraph and OCR records of all employees',
