...
export default function ShiftNoteCell({
  ...
  return (
    ...
    >
      {text && (
        <p className="whitespace-pre-line text-[11px] font-medium leading-snug text-gray-800">
          {text}
        </p>
      )}
      ...
      {canManage && empty && (
        <span className="no-print flex items-center gap-1 text-[11px] text-gray-400 opacity-0
