...
INSERT INTO holidays (date, name, year) VALUES
    ('2025-01-01', 'Den vzniku Slovenskej republiky', 2025),
    ('2025-01-06', 'Zjavenie Pana', 2025),
    ('2025-04-18', 'Velky piatok', 2025),
    ('2025-04-21', 'Velkonocny pondelok', 2025),
    ('2025-05-01', 'Sviatok prace', 2025),
    ('2025-05-08', 'Den vitazstva nad fasizmom', 2025),
    ('2025-07-05', 'Sviatok sv. Cyrila a Metoda', 2025),
    ('2025-08-29', 'Vyrocie SNP', 2025),
    ('2025-09-01', 'Den Ustavy SR', 2025),
    ('2025-09-15', 'Sedembolestna Panna Maria', 2025),
    ('2025-11-01', 'Sviatok vsetkych svatych', 2025),
    ('2025-11-17', 'Den boja za slobodu a demokraciu', 2025),
    ('2025-12-24', 'Stedry den', 2025),
    ('2025-12-25', 'Prvy sviatok vianocny', 2025),
    ('2025-12-26', 'Druhy sviatok vianocny', 2025),
    ('2026-01-01', 'Den vzniku Slovenskej republiky', 2026),
    ('2026-01-06', 'Zjavenie Pana', 2026),
    ('2026-04-03', 'Velky piatok', 2026),
    ('2026-04-06', 'Velkonocny pondelok', 2026),
    ('2026-05-01', 'Sviatok prace', 2026),
    ('2026-05-08', 'Den vitazstva nad fasizmom', 2026),
    ('2026-07-05', 'Sviatok sv. Cyrila a Metoda', 2026),
    ('2026-08-29', 'Vyrocie SNP', 2026),
    ('2026-09-01', 'Den Ustavy SR', 2026),
    ('2026-09-15', 'Sedembolestna Panna Maria', 2026),
    ('2026-11-01', 'Sviatok vsetkych svatych', 2026),
    ('2026-11-17', 'Den boja za slobodu a demokraciu', 2026),
    ('2026-12-24', 'Stedry den', 2026),
    ('2026-12-25', 'Prvy sviatok vianocny', 2026),
    ('2026-12-26', 'Druhy sviatok vianocny', 2026)
